...
<<<<<<< HEAD
    ...
    @GetMapping("/descricao/{descricaoc}")
    public ResponseEntity<List<Categoria>> getByDescricao(@PathVariable String descricaoc) {
        return ResponseEntity.ok(categoriaRepository.findAllByDescricaocContainingIgnoreCase(descricaoc));
    }
...
=======
	...
	public ResponseEntity<List<Categoria>> getByDescricao(@PathVariable String descricao) {
		return ResponseEntity.ok(categoriaRepository.findAllByDescricaocContainingIgnoreCase(descricao));
	}
	...
	@PutMapping
>>>>>>> 487dcdb7383e1fbd29e640f68f057da4801e80e1
